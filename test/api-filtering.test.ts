...
describe('SmartSuite API Filtering', () => {
  ...
  describe('Integration Tests', () => {
    it('should demonstrate the 400 Bad Request issue with simple filters', async () => {
      ...
      expect(transformedFilter.fields).toHaveLength(1);
      expect(transformedFilter.fields[0]).toEqual({
        field: 'autonumber',
        comparison: 'is', 
        value: 'EAV007'
      });
