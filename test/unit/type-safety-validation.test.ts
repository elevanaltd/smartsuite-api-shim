...
describe('Type Safety Validation - Sentinel Architecture', () => {
  ...
  it('should validate ToolContext interface is properly typed', () => {
    ...
    expect(mockContext.serverInstance).toBeDefined();
    expect(mockContext.clientInstance).toBeDefined();
    expect(mockContext.mappingService).toBeDefined();
    expect(mockContext.knowledgeService).toBeDefined();
    expect(mockContext.transactionHistory).toBeDefined();
  });
