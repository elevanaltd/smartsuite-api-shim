...
describe('KnowledgeLibrary Pattern Matching', () => {
  ...
  describe('SmartSuite API Pattern Coverage', () => {
    ...
    it.each(criticalEndpoints)('should recognize pattern for $description ($method $path)', ({ method, path, description }) => {
  ...
  describe('Real-World Pattern Validation', () => {
    it('should detect actual SmartSuite API anti-patterns', () => {
      ...
      for (const antiPattern of antiPatterns) {
        ...
        // System should either have specific knowledge or allow learning
        expect(() => {
          library.findRelevantKnowledge(antiPattern.method, antiPattern.endpoint, antiPattern.payload);
        }).not.toThrow();
      }
    });
    ...
    it('should maintain knowledge base version integrity', () => {
      ...
      expect(new Date(newVersion.lastUpdated).getTime()).toBeGreaterThan(
